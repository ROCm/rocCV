...
- **Random tensor data** is regenerated per benchmark via `rocrand`. For data-dependent operators (e.g., conditional thresholding) this contributes a small amount of variance. The dominant noise sources elsewhere swamp it in practice.
